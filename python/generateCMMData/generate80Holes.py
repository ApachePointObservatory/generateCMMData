...
def generate80Holes(inFilePath, outDir, useFlat=True):
    """Generate one CMM file with 80 well-spaced holes from a plPlugMap*.par file.

    This function produces files with format NXXXX so it should not be used
    along with generate37Holes.py
